...
<div class="mb-8 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
    ...
    <div class="flex flex-wrap gap-3">
        ...
        <a href="/schedulio" class="inline-flex items-center px-4 py-2.5 border border-transparent rounded-lg shadow-sm text-sm font-semibold text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all">
            <svg class="-ml-1 mr-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.548a3 3 0 00-4.242 0L13 5.657z" />
            </svg>
            Cek Prioritas
        </a>
    </div>
    ...
    <div class="space-y-6">
        <div class="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl shadow-md p-6 text-white relative overflow-hidden">
            ...
            <div class="mt-3 flex items-baseline text-4xl font-extrabold">
                <span id="completedCount"><?= $completedTasks ?? 0 ?></span>
                <span class="ml-2 text-sm font-medium text-indigo-200">Tugas</span>
            </div>
